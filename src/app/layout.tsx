...
export default function TikTokPixel({ product, cartItems, cartTotal, orderItems, orderTotal }) {
  useEffect(() => {
    if (typeof window !== "undefined" && window.ttq) {
      ...
      // ====== AddToCart ======
      // Call this function when AddToCart button clicked
      window.handleAddToCartTT = (item) => {
        ttq.track("AddToCart", {
          contents: [
            {
              content_id: item.id,
  ...
  }, [product, cartItems, cartTotal, orderItems, orderTotal]);
